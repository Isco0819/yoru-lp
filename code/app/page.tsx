    ...
    <div className="min-h-screen bg-white text-[#0B1220]">
      ...
      <section id="book" className="py-20 md:py-32 px-6 bg-[#0B1220]/5">
        <div className="max-w-2xl mx-auto">
          ...
          {/* 利用規約（スクロールボックス） */}
<div className="space-y-2 text-xs sm:text-sm border rounded-md p-3 max-h-64 overflow-y-auto bg-slate-50 mt-4">
  <p className="font-semibold">利用規約</p>
  <p>
    当店のサービスをご利用いただくにあたり、下記の「利用規約」を施術までに必ずご確認ください。
    施術に入る際には、利用規約に承諾頂いたものとさせて頂きます。
    ご了承いただけない場合はキャンセルのご連絡をお願い致します。
  </p>
  <p>
    当店は以下をご承諾いただいた方に限り、施術をさせていただいております。
    利用規約に同意頂けない場合はご利用をお断り致しております。ご理解とご協力をお願い致します。
  </p>

  <p className="font-semibold mt-2">1）当店のサービスについて</p>
  <p>
    当店はリラクゼーションを目的として運営・提供するサービスであり、「医療法」が定める
    「病院 、診療所、治療院」等ではありません。法的な医療法等が定めるサービスの提供は行っておりません。
  </p>

  <p className="font-semibold mt-2">2）体調・体調不良について</p>
  <p>
    施術前後、お客様の生活上の体調不良や不調に関して、いかなる場合でも当店は一切の責任を負いません。
  </p>

  <p className="font-semibold mt-2">3）施術を控えさせていただく場合</p>
  <p>以下の項目に当てはまる場合、当店での施術は控えさせていただいております。</p>
  <ul className="list-disc pl-5 space-y-1">
    <li>心臓病、高血圧、腎臓病、糖尿病、てんかんなどのご病気の方</li>
    <li>ヘルニア、重度の腰痛、神経痛、側弯症などがある方</li>
    <li>悪性腫瘍、動脈瘤、動脈硬化、静脈瘤のある方</li>
    <li>怪我・火傷・打撲・捻挫などの炎症・肉離れをおこしている方</li>
    <li>伝染性皮膚炎、重度の水虫、皮膚に炎症がある方</li>
    <li>半年以内に手術（美容整形を含む）をされた方、又は著しく体力が低下している方</li>
    <li>整形外科または外科に通院中の方</li>
    <li>医師に施術行為を止められている方</li>
    <li>過去にマッサージやリラクゼーションで体調不良になったことがある方</li>
    <li>風邪などで発熱のある方</li>
    <li>泥酔されている方</li>
    <li>多量の食事後の方</li>
    ...
    <li>未成年者の方</li>
    <li>暴力団関係者の方</li>
    <li>薬物等を使用していると見受けられる方</li>
  </ul>
  <p className="text-[11px] sm:text-xs text-slate-500">
    ※施術開始前までに上記項目の申告がなかった場合、または上記項目に該当するお客様がご自身の判断で施術を受けられた場合、
    施術後の体調不良に関して当店では一切の責任を負いかねますので予めご了承ください。
  </p>

  <p className="font-semibold mt-2">4）禁止行為について</p>
  <p>
    お客様による下記の事項は一切禁止いたします。このような場合、施術前および施術中であっても施術を中止し、
    施術料金の返金には応じかねます。また、必要と判断した場合には所轄警察署までご同行いただくことがあります。
  </p>
  <ul className="list-disc pl-5 space-y-1">
    <li>施術内容以外で施術者へ触れる行為、危険を感じる言動その他不適切と判断される行為</li>
    <li>風俗的サービスの要求、性器を見せる行為、自慰行為</li>
    <li>セラピストの個人情報や連絡先の要求</li>
    <li>セラピストへの直接施術交渉や引き抜き行為</li>
    <li>事前許可なく録音・写真撮影・動画撮影を行うこと</li>
    <li>カメラ・携帯電話・スマートフォン等の撮影機能の無断使用</li>
  </ul>

  <p className="font-semibold mt-2">5）貴重品の管理</p>
  <p>
    施術中の貴重品の管理はお客様ご自身でお願いいたします。
    当店の責に帰すべき事由による場合を除き、紛失・盗難について一切の責任を負いません。
  </p>

  <p className="font-semibold mt-2">6）個人情報の取扱い</p>
  <p>
    ご予約時に頂いた個人情報は、お問い合わせ対応のほか、当社サービスに関する情報提供（電子メール、SNS、電話等）に
    利用する場合があります。
  </p>

  <p className="font-semibold mt-2">7）所要時間について</p>
  <p>
    各施術コースの所要時間には、施術後のお部屋の片付けおよびご退出準備の時間を含みます。
    実際の施術はコース終了時刻の5分前を目安に終了いたします。
  </p>
</div>
...
<div className="flex items-start gap-2 mt-3">
  <input
    ...
    className="mt-1"
  />
  <label htmlFor="agreeTerms" className="text-xs sm:text-sm">
    上記の利用規約を読み、内容に同意します。
  </label>
</div>
